========================================
Getting started with PengERP development
========================================
...
Launchpad to be able to collaborate on PengERP development. Please
...
PengERP provides a setup script that automatizes the tasks of creating
a shared repository and getting the source code. Get the setup script
of PengERP by typing::
...
sources. Get the current trunk version of PengERP by typing::
...
Some dependencies are necessary to use PengERP. Depending on your
...
Finally, launch the PengERP server::

  make server

Testing your installation can be done on http://localhost:8069/. You
should see the PengERP main login page.
...
Some options were removed in PengERP version 6. For example,
...
To run the PengERP server, the conventional approach is to use the
...
`pengerp.command` that can, among other things, launch the server.
