...
def setup_modifiers(node, field=None, context=None, in_tree_view=False):
    ...
    :param node: ``field`` node from an PengERP view
...
class MetaModel(type):
    ...
    def __init__(self, name, bases, attrs):
        ...
        # The (PengERP) module name can be in the `openerp.addons` namespace
...
class BaseModel(object):
    """ Base class for PengERP models.

    PengERP models are created by inheriting from this class' subclasses:
    ...
    def default_get(self, cr, uid, fields_list, context=None):
        ...
        :param context: optional context dictionary - it may contains keys for specifying certain options
                        ...
                        Note: The ``bin_size_XXX`` form is new in PengERP v6.0.
...
# TODO: set order
    ...
    def _where_calc(self, cr, user, domain, active_test=True, context=None):
        """Computes the WHERE clause needed to implement an PengERP domain.
...
class Model(BaseModel):
    """Main super-class for regular database-persisted PengERP models.

    PengERP models are created by inheriting from this class::
