...
term representation was ['=', 'company_id.name', 'PengERP']. Used in a
...
PengERP will use the SQL function 'unaccent' when available for the
...
Finally, to instruct PengERP to really use the unaccent function, you have to
