...
# Copyright 2010 PengERP SA. (http://www.pengerp.com)
#
#
...
""" This module offers the family of HTTP-based servers. These are not a single
    ...
    The PengERP server defines a single instance of a HTTP server, listening at
...
class PengERPAuthProvider(AuthProvider):
    """ Require basic authentication."""
    def __init__(self,realm='PengERP User'):
        self.realm = realm
        self.auth_creds = {}
        self.auth_tries = 0
        self.last_auth = None
