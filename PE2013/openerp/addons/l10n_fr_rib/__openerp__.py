...
As a safety measure, PengERP will check the RIB key whenever a RIB is saved, and
...
Accounts in PengERP: the first with the type 'RIB', the second with the type 'IBAN'. 
""",
