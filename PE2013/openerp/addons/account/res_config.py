...
#    Copyright (C) 2004-2012 PengERP S.A. (<http://pengerp.com>).
#
...
class account_config_settings(osv.osv_memory):
    ...
    _columns = {
        ...
        'paypal_account': fields.related('company_id', 'paypal_account', type='char', size=128,
            string='Paypal account', help="Paypal account (email) for receiving online payments (credit card, etc.) If you set a paypal account, the customer  will be able to pay your invoices or quotations with a button \"Pay with  Paypal\" in automated emails or through the PengERP portal."),
