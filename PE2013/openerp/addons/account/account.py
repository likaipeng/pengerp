...
#                if can_compute:
    ...
    def name_search(self, cr, user, name, args=None, operator='ilike', context=None, limit=100):
        ...
        if name:
            ...
            if not ids and len(name.split()) >= 2:
                ...
                operand1,operand2 = name.split(' ',1) #name can contain spaces e.g. PengERP S.A.
    ...
    # 'configurable' since it can lead to a lack of confidence in PengERP and this is what we want to change.
...
class account_account_template(osv.osv):
    ...
    _columns = {
        ...
        'type': fields.selection([
            ...
            "special effects in PengERP: view can not have entries, consolidation are accounts that "\
            "can have children accounts for multi-company consolidations, payable/receivable are for "\
            "partners accounts (for debit/credit computations), closed for depreciated accounts."),
        'user_type': fields.many2one('account.account.type', 'Account Type', required=True,
