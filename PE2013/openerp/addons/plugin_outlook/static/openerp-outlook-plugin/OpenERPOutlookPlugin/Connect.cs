...
namespace PengERPOutlookPlugin
{
    ...
    // you will need to re-register the Add-in by building the PengERPOutlookPluginSetup project, 
    ...
    [GuidAttribute("C86B5760-1254-4F40-BD25-2094A2A678C4"), ProgId("PengERPOutlookPlugin.Connect")]
    public class Connect : Object, Extensibility.IDTExtensibility2
    {
        ...
        public static bool isLoggedIn()
        {
             ...
             */
            if (Cache.PengERPOutlookPlugin == null || Cache.PengERPOutlookPlugin.isLoggedIn == false)
            {
                throw new Exception("PengERP Server is not connected!\nPlease connect PengERP Server from Configuration Menu.");
            ...
            try
            {
                ...
                if (countMail() == 1)
                {
                    ...
                    foreach (outlook.MailItem mailitem in Tools.MailItems())
                    {
                        ...
                        Object[] contact = Cache.PengERPOutlookPlugin.RedirectPartnerPage(mailitem);
                        if ((int)contact[1] > 0)
                        {
                            Cache.PengERPOutlookPlugin.RedirectWeb(contact[2]);
                        }
                        else
                        {
