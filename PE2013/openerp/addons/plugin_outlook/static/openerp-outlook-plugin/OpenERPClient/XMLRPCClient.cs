...
{
    public interface IPengERPCommon : IXmlRpcProxy
    {
        [XmlRpcMethod("login")]
        object Login(string dbname, string username, string pwd);

    }
    public interface IPengERPObject : IXmlRpcProxy
    {
    ...
    public interface IPengERPDB : IXmlRpcProxy
    {
    ...
    public interface Ixmlrpcconnect : IPengERPCommon, IPengERPDB, IPengERPObject
    {
    }
