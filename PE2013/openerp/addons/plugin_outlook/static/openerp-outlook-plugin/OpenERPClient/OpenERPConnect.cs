...
namespace PengERPClient
{
    ...
    public class PengERPConnect
    {
        ...
        public PengERPConnect()
        {
        }
        public PengERPConnect(string url)
        {
            /*
        ...
        public PengERPConnect(string url, string dbname, string login, string pwd)
        {
            /*
             It will do the connection with PengERP server.
             :param url : url with the server and port.
        ...
        {
            /*
            It will check whether successfully login to PengERP is done or not.
        ...
        public int Login(string dbname, string userid, string pwd)
        {
            /*
             ...
             and on that basis it will allow the user for connecting to PengERP.
            ...
            */
            ...
            this.Open(PengERPClient.PengERPService.Common);
        ...
        public object Execute(string model, string method, params object[] args)
        {
            ...
            */
            ...
            this.Open(PengERPClient.PengERPService.Object);
        ...
        public object[] DBList()
        {
            ...
            */
            ...
            this.Open(PengERPClient.PengERPService.DB);
