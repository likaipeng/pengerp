...
class outlook_installer(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res['plugin32'] = base_url + '/plugin_outlook/static/openerp-outlook-plugin/PengERPOutlookPluginSetup32.msi'
        res['plugin64'] = base_url + '/plugin_outlook/static/openerp-outlook-plugin/PengERPOutlookPluginSetup64.msi'
        return res
