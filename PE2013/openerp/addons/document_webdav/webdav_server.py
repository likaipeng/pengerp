...
#   which they import and override to suit PengERP functionality.
...
from openerp.service.http_server import reg_http_service,PengERPAuthProvider

class DAVAuthProvider(PengERPAuthProvider):
    def authenticate(self, db, user, passwd, client_address):
        ...
        if db is False:
            return True
        return PengERPAuthProvider.authenticate(self, db, user, passwd, client_address)
...
def init_principals_redirect():
    ...
    the user's properties. In PengERP we _cannot_ have a stray /principals/...
