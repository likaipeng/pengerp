...
#    Copyright (C) 2004-2012 PengERP SA (<http://www.pengerp.com>).
#
...
*for a text document with url like `https://docs.google.com/a/pengerp.com/document/d/123456789/edit`, the ID is `document:123456789`
*for a spreadsheet document with url like `https://docs.google.com/a/pengerp.com/spreadsheet/ccc?key=123456789#gid=0`, the ID is `spreadsheet:123456789`
*for a presentation (slide show) document with url like `https://docs.google.com/a/pengerp.com/presentation/d/123456789/edit#slide=id.p`, the ID is `presentation:123456789`
*for a drawing document with url like `https://docs.google.com/a/pengerp.com/drawings/d/123456789/edit`, the ID is `drawings:123456789`
...
''', required=True),
