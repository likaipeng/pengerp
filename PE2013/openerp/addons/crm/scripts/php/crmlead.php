...
class Contact
{
                ...
                if(!$res2->faultCode())
                {
                    ...
                    if (!empty($readVal))
                    {
                        $val = array ( "description" => new xmlrpcval("About: ".$post['about']),
                                ...
                                "email_from" => new xmlrpcval($post['email'], "string"),
                                "email_to" => new xmlrpcval("sales@pengerp.com", "string")
                                );
                        ...
                        if(strstr($post["about"],"Book")) {
                            echo '<script>window.location="http://www.pengerp.com/index.php?option=com_content&amp;id=54"</script>';
                        }
                    }
                    else
                    {
    ...
    if(isset($_POST['country']) && $_POST['country'] != '') {
        ...
        $cnt = new Contact('sales5@pengerp.com', 'Country: '.$arrData['country']. ' About: ' .$arrData['about']);
