...
#    Copyright (C) 2004-today PengERP SA (<http://www.pengerp.com>)
#
...
class crm_case_section(osv.osv):
    ...
    _columns = {
        ...
        'reply_to': fields.char('Reply-To', size=64, help="The email address put in the 'Reply-To' of all emails sent by PengERP about cases in this sales team"),
