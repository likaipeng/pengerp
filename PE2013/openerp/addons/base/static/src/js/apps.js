    ...
    instance.base.Apps = instance.web.Widget.extend({
        ...
        get_client: function() {
            ...
            if (instance.base.apps_client) {
                ...
                return ICP.call('get_param', ['apps.server', 'https://apps.pengerp.com/apps']).then(function(u) {
        ...
        start: function() {
            ...
            return self.get_client().
                ...
                fail(function(client) {
                    self.do_warn(_t('PengERP Apps Unreachable'), _t('Showing locally available modules'), true);
