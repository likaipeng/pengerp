...
class ir_model_constraint(Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by PengERP
    models.
    """
...
class ir_model_relation(Model):
    """
    This model tracks PostgreSQL tables used to implement PengERP many2many
    relations.
    """
...
class ir_model_data(osv.osv):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by PengERP
