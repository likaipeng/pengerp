...
-------------------------------------------------------------------------------
    ...
    3) When the previous step doesn't find a match, the transaction counterparty is 
       located via the Bank Account Number configured on the PengERP Customer and 
       Supplier records.
...
re-import the CODA after updating the PengERP database with the information that 
