// constants
const APP_DISPLAY_NAME = "PengERP Thunderbird Plugins";
const APP_NAME = "PengERP";
const APP_VERSION = "1.0";
const WARNING = "WARNING: You need administrator privileges to install PengERP Thunderbird Plugin. It will be installed in the application directory for all users.";
...
if (!incompatible && confirm(WARNING, APP_DISPLAY_NAME)) {
	...
	try {
		...
		alert("PengERP Thunderbird Plugin " + APP_VERSION + " is now installed.\n" +
