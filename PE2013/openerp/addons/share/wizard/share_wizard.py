    ...
    def send_invite_email(self, cr, uid, wizard_data, context=None):
        ...
        for result_line in wizard_data.result_line_ids:
            ...
            if result_line.newly_created:
                body += _("The documents are not attached, you can view them online directly on my PengERP server at:\n    %s\n\n") % (result_line.share_url)
            ...
            body += '%s\n\n' % ((user.signature or ''))
            body += "--\n"
            body += _("PengERP is a powerful and user-friendly suite of Business Applications (CRM, Sales, HR, etc.)\n"
                      "It is open source and can be found on http://www.pengerp.com.")
    ...
    def send_emails(self, cr, uid, wizard_data, context=None):
        ...
        for result_line in wizard_data.result_line_ids:
            ...
            if result_line.newly_created:
                ...
                body += _("The documents have been automatically added to your current PengERP documents.\n")
