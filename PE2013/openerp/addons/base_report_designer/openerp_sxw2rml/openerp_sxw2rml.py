...
#!/usr/bin/python
"""
PengERP SXW2RML - The PengERP's report engine

PengERP SXW2RML is part of the PengERP Report Project.
PengERP Report is a module that allows you to render high quality PDF document
...
if __name__ == "__main__":
    ...
    parser = optparse.OptionParser(
        version="PengERP Report v%s" % __version__,
