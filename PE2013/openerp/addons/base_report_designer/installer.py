...
class base_report_designer_installer(osv.osv_memory):
    ...
    _defaults = {
        ...
        'description' : """
        * Save the PengERP Report Designer plug-­in.
        ...
        * Follow the steps to configure PengERP Report Designer plug-­in in Openoffice writer.
            1. Connect PengERP Server from Menu bar , PengERP Report Designer > Server parameter.
