...
class procurement_order(osv.osv):
    ...
    _columns = {
        ...
        'origin': fields.char('Source Document', size=64,
            ...
            "This is automatically completed by PengERP."),
...
class stock_warehouse_orderpoint(osv.osv):
    ...
    _columns = {
        ...
        'product_min_qty': fields.float('Minimum Quantity', required=True,
            help="When the virtual stock goes below the Min Quantity specified for this field, PengERP generates "\
            "a procurement to bring the forecasted quantity to the Max Quantity."),
        'product_max_qty': fields.float('Maximum Quantity', required=True,
            help="When the virtual stock goes below the Min Quantity, PengERP generates "\
