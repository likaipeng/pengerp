...
class account_sequence_installer(osv.osv_memory):
    ...
    _columns = {
        ...
        'padding' : fields.integer('Number padding', required=True, help="PengERP will automatically adds some '0' on the left of the 'Next Number' to get the required padding size."),
