...
Building an PengERP Web module
==============================

There is no significant distinction between an PengERP Web module and
an PengERP module, the web part is mostly additional data and code
inside a regular PengERP module. This allows providing more seamless
features by integrating your module deeper into the web client.

A Basic Module
--------------

A very basic PengERP module structure will be our starting point:
...
This is a sufficient minimal declaration of a valid PengERP module.

Web Declaration
---------------

There is no such thing as a "web module" declaration. An PengERP
...
.. note::
    ...
    restart the PengERP server itself for it to be taken in account.
...
provides: an instance of the PengERP Web client, with the contents of
...
will require restarting the PengERP Server to see the changes, as
usual):
...
.. note::
    ...
    will apply only within the confines of the PengERP Web client) and
...
PengERP Web's template language is :doc:`qweb`. Although any
...
integration to PengERP Web widgets.
