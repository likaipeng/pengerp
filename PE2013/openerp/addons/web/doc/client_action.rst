...
Client actions are the client-side version of PengERP's "Server
...
In the PengERP Web code, a client action only requires two pieces of
information:
...
* Providing said object. Two different types of objects can be mapped
  ...
  * An PengERP Web widget, which must inherit from
