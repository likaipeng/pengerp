...
def fix_view_modes(action):
    """ For historical reasons, PengERP has weird dealings in relation to
...
class Menu(openerpweb.Controller):
    ...
    def get_user_roots(self, req):
        ...
        :param req: A request object, with an PengERP session attribute
        :type req: < session -> PengERPSession >
...
class Export(View):
    ...
    def from_data(self, fields, rows):
        """ Conversion method from PengERP's export data to whatever the
