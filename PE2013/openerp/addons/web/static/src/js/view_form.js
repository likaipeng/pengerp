 ...
 *     This event is not related to the on_change mechanism of PengERP and is always called
...
instance.web.form.FieldManagerMixin = {
    ...
    */
    ...
    /**
    Computes an PengERP domain.

    @param (list) expression An PengERP domain.
    ...
    */
    ...
    @return (CompoundContext) An PengERP context.
    */
...
instance.web.FormView = instance.web.View.extend(instance.web.form.FieldManagerMixin, {
     ...
     * @param {String} view_id the identifier of the PengERP view object
...
instance.web.form.FieldInterface = {
     ...
     * osv class in the PengERP server as well as the syntax used by the set_value() (see below). It must
     ...
     * the PengERP server, although it is not assumed to respect the constraints applied to the field.
...
instance.web.form.AbstractField = instance.web.form.FormWidget.extend(instance.web.form.FieldInterface, {
    ...
    */
     ...
     * value is similar to false in PengERP.
     */
    is_false: function() {
 ...
 * will substitute to the <field> tags as defined in PengERP's views.
 */
 ...
 * tags defined in PengERP's form views.
 *
