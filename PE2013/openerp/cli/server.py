...
"""
PengERP - Server
PengERP is an ERP+CRM program for small and medium businesses.

The whole source code is distributed under the terms of the
GNU Public Licence.

(c) 2003-TODAY, Fabien Pinckaers - PengERP SA
"""
...
def report_configuration():
    ...
    """
    config = openerp.tools.config
    _logger.info("PengERP version %s", __version__)
...
def main(args):
    ...
    _logger.info('PengERP server is running, waiting for connections...')
    quit_on_signals()
