...
def start_openerp():
    """
    Start the PengERP server similary to the openerp-server script.
    """
...
def stop_openerp():
    """
    Shutdown the PengERP server similarly to a single ctrl-c.
    """
    openerp.service.stop_services()

class BaseCase(unittest2.TestCase):
    """
    Subclass of TestCase for common PengERP-specific code.
