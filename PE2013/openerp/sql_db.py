...
"""
The PostgreSQL connector is a connectivity layer between the PengERP code and
...
class Cursor(object):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``psycopg1cursor`` objects.
        ...
        such as PengERP, we need the best guarantees that no data
        ...
        PengERP implements its own level of locking protection
        ...
        the default transaction isolation level for PengERP cursors, as
